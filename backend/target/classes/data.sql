...
-- 1. Users
REPLACE INTO users (id, username, email, password, full_name, role, avatar_url, designation) VALUES
...
-- 2. Projects
INSERT IGNORE INTO projects (id, project_key, name, description, status, budget, start_date, end_date, manager_id, progress) VALUES
...
-- 3. Tasks
INSERT IGNORE INTO tasks (id, title, description, status, priority, project_id, reporter_id, assignee_id, due_date, estimated_hours) VALUES
...
-- 4. Comments
INSERT IGNORE INTO comments (id, task_id, author_id, content, created_at) VALUES
